...
insert into `freight_transport_region_terminals`.`ftr_terminals` (`terminal_id`,`terminal_name`,`country`,`item_type`,`terminal_description`,`capacity`,`available_capacity`,`status`,`harborLocation`, `country`) values("T5","Brisbane","Australia","Electronics","T5-Electronics","50000","12000","NotAvailable","Sydney Harbor", "Australia");
