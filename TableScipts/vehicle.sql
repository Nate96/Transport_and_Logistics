...
insert into `freight_transport_region_vehicles`.`ftr_vehicles` (`vehicle_number`,`vehicle_name`,`max_lifting_capacity`,`retire_date`,`vehicle_status`,`harbor_location`, `country`) values("UE7890","Tower crane","19.8","2030-12-20","InProgress", "Chennai Port", "India");
...
insert into `freight_transport_region_vehicles`.`ftr_vehicles` (`vehicle_number`,`vehicle_name`,`max_lifting_capacity`,`retire_date`,`vehicle_status`,`harbor_location`, `country`) values("CT7867","Crawler crane","550","2024-05-27","InActive", "Busan Port", "South Korea");
